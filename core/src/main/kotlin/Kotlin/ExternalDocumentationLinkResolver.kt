...
class PackageListProvider @Inject constructor(
    ...
    fun loadPackageList(link: DokkaConfiguration.ExternalDocumentationLink) {
        ...
        val resolver = constructor.call(link.useDashAsParameterSeparator, link.useDotAsNestedClassSeparator, paramsMap) as InboundExternalLinkResolutionService
...
interface InboundExternalLinkResolutionService {
    ...
    class Javadoc(dash: Boolean, dot: Boolean, paramsMap: Map<String, List<String>>) : InboundExternalLinkResolutionService {
        val useDashAsParameterSeparator = dash
        val useDotAsNestedClassSeparator = dot
        ...
        override fun getPath(symbol: DeclarationDescriptor): String? {
            if (symbol is EnumEntrySyntheticClassDescriptor) {
                ...
                if (useDotAsNestedClassSeparator && !DescriptorUtils.isTopLevelDeclaration(symbol)) {
    ...
    class Dokka(dash: Boolean, dot: Boolean, val paramsMap: Map<String, List<String>>) : InboundExternalLinkResolutionService {
