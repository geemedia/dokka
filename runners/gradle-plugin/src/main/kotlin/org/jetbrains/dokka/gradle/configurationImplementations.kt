...
class GradleExternalDocumentationLinkImpl(
    ...
    override val useDotAsNestedClassSeparator: Boolean
    ...
    open class Builder(open var url: URL? = null,
                       ...
                       open var useDotAsNestedClassSeparator: Boolean = false) {
        ...
        fun build(): ExternalDocumentationLink =
            if (packageListUrl != null && url != null)
                GradleExternalDocumentationLinkImpl(url!!, packageListUrl!!, useDashAsParameterSeparator, useDotAsNestedClassSeparator)
            else if (url != null)
                GradleExternalDocumentationLinkImpl(url!!, URL(url!!, "package-list"), useDashAsParameterSeparator, useDotAsNestedClassSeparator)
            else
