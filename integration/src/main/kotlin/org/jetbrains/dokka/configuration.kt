...
interface DokkaConfiguration {
    ...
    interface ExternalDocumentationLink {
        ...
        val useDotAsNestedClassSeparator: Boolean
        ...
        open class Builder(open var url: URL? = null,
            ...
            fun build(): ExternalDocumentationLink =
                if (packageListUrl != null && url != null)
                    ExternalDocumentationLinkImpl(url!!, packageListUrl!!, useDashAsParameterSeparator, useDotAsNestedClassSeparator)
                else if (url != null)
                    ExternalDocumentationLinkImpl(url!!, URL(url!!, "package-list"), useDashAsParameterSeparator, useDotAsNestedClassSeparator)
                else
